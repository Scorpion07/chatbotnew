    ...
    <div className='min-h-screen'>
      ...
      <section className='max-w-7xl mx-auto px-3 sm:px-6 py-10 sm:py-20'>
        <div className='text-center max-w-2xl sm:max-w-4xl mx-auto'>
          ...
          <h1 className='text-4xl sm:text-6xl md:text-7xl font-bold leading-tight mb-6 bg-gradient-to-r from-gray-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent break-words'>
            All Your AI Models
            <br />
            <span className='bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent'>In One Place</span>
          </h1>
          <p className='text-base sm:text-xl text-gray-600 mb-8 sm:mb-10 max-w-2xl sm:max-w-3xl mx-auto leading-relaxed'>
        ...
        {/* Preview Window */}
        <div className='mt-10 sm:mt-20 max-w-full sm:max-w-5xl mx-auto'>
          <div className='bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden'>
            <div className='bg-gradient-to-r from-gray-800 to-gray-900 px-3 sm:px-4 py-2 sm:py-3 flex items-center gap-2'>
            ...
            <div className='p-3 sm:p-8 bg-gradient-to-br from-gray-50 to-white'>
              <div className='flex gap-2 sm:gap-3 mb-4 sm:mb-6 flex-wrap'>
                {['GPT-4o mini', 'Claude 3.5 Sonnet', 'Gemini 1.5 Pro', 'Grok-4'].map((model, i) => (
                  <div key={model} className={`px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium ${i === 0 ? 'bg-indigo-600 text-white shadow-lg' : 'bg-gray-200 text-gray-600'}`}>
                    {model}
                  </div>
                ))}
              </div>
              <div className='space-y-3 sm:space-y-4'>
                <div className='flex gap-2 sm:gap-3'>
                  <div className='w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex-shrink-0'></div>
                  <div className='flex-1 bg-gray-100 rounded-2xl rounded-tl-none px-3 sm:px-4 py-2 sm:py-3'>
                    <p className='text-gray-700'>Hello! How can I assist you today?</p>
                  </div>
                </div>
                <div className='flex gap-2 sm:gap-3 justify-end'>
                  <div className='flex-1 max-w-xs sm:max-w-md bg-indigo-600 text-white rounded-2xl rounded-tr-none px-3 sm:px-4 py-2 sm:py-3'>
                    <p className='text-xs sm:text-base'>Help me with my coding project</p>
                  </div>
                  <div className='w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-indigo-500 to-pink-500 rounded-full flex-shrink-0'></div>
                </div>
              </div>
              <div className='mt-4 sm:mt-6 flex gap-2 items-center'>
                <input type='text' placeholder='Type your message...' className='flex-1 px-3 sm:px-4 py-2 sm:py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-600 focus:outline-none text-sm sm:text-base' />
                <button className='p-2 sm:p-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors'>
        ...
        <div className='max-w-7xl mx-auto px-3 sm:px-6'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8'>
            {[
              ...
              <div key={i} className='p-4 sm:p-6 rounded-2xl border-2 border-gray-100 hover:border-indigo-200 hover:shadow-xl transition-all bg-gradient-to-br from-white to-gray-50'>
      ...
      <section className='py-10 sm:py-20'>
        <div className='max-w-2xl sm:max-w-4xl mx-auto px-3 sm:px-6 text-center'>
          <div className='bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-6 sm:p-12 shadow-2xl'>
            <h2 className='text-2xl sm:text-4xl font-bold text-white mb-3 sm:mb-4'>Ready to get started?</h2>
            <p className='text-base sm:text-xl text-indigo-100 mb-6 sm:mb-8'>Join thousands of users already chatting with AI</p>
            <button onClick={() => setView('chat')} className='px-6 sm:px-8 py-3 sm:py-4 bg-white text-indigo-600 rounded-xl font-semibold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl text-sm sm:text-base'>
