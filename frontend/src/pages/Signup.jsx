      ...
      <div className="w-full max-w-md bg-white/90 backdrop-blur rounded-2xl shadow-xl border border-gray-200 p-8">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
                ...
                {showPassword ? (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10 0-1.044.159-2.05.455-3M6.343 6.343A9.956 9.956 0 0112 5c5.523 0 10 4.477 10 10 0 1.537-.346 2.992-.964 4.29M3 3l18 18M9.88 9.88a3 3 0 104.24 4.24"
                    />
                  </svg>
                ) : (
                  <svg
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M12 4.5C7.305 4.5 3.29 7.362 1.5 12c1.79 4.638 5.805 7.5 10.5 7.5s8.71-2.862 10.5-7.5C20.71 7.362 16.695 4.5 12 4.5z"
                    />
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
